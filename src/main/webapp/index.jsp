    ...
    <div class="bg-white mx-auto text-center w-1/2 py-5 shadow-xl rounded-3xl my-96 max-w-2xl ">
        ...
        <form method="post" action="/">
            ...
            <div class="grid grid-cols-2 gap-4 my-4 mx-8">
                <label class="text-xl-flex items-center">Principal Amount <span class="text-gray-500 mx-1">Rs.</span></label>
                ...
                <label class="text-xl-flex items-center">interest presentage </label>
                ...
                <label class="text-xl-flex items-center"># of year :</label>
